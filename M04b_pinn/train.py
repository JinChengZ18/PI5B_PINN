...
from M04b_pinn.dataset import ThermalHeatSourceDataset
from M04b_pinn.model import SimplePINN
from M04b_pinn.logger import setup_logger
...
def parse_args():
    ...
    parser.add_argument("--log_dir", type=str, default="logs/M04b")
    parser.add_argument("--ckpt_dir", type=str, default="checkpoints/M04b")
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        for x7, T_norm, T_min, T_max in loader:
            try:
                ...
                pred = model(x7)
                loss_data = F.mse_loss(pred, T_norm)

                lap = model.laplacian(x7)
                pde_weight = compute_soft_mask(T_norm, args)
    ...
    ckpt_path = ckpt_dir / "M04b_pinn.pt"
