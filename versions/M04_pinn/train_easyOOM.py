...
from M04_pinn.logger import setup_logger
...
def parse_args():
    ...
    parser.add_argument("--log_dir", type=str, default="logs/M04")
    parser.add_argument("--ckpt_dir", type=str, default="checkpoints/M04")
...
def main():
    ...
    ckpt_path = ckpt_dir / "M04_pinn.pt"
