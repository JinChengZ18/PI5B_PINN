...
from M04d_pinn.dataset import ThermalHeatSourceDataset
from M04d_pinn.model import SimplePINN
from M04d_pinn.logger import setup_logger
...
def parse_args():
    ...
    parser.add_argument("--cosine_tmax",type=int,default=150,
                        help="CosineAnnealingLR 的 T_max（通常设为 epochs）")
    ...
    parser.add_argument("--pde_anneal_gamma", type=float, default=0.2)
    ...
    parser.add_argument("--log_dir", type=str, default="logs/M04d")
    parser.add_argument("--ckpt_dir", type=str, default="checkpoints/M04d")
...
def main():
    ...
    ckpt_path = ckpt_dir / "M04d_pinn.pt"
