...
class ThermalHeatSourceDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        params_min = params_raw.min(dim=0, keepdim=True)[0]
        params_max = params_raw.max(dim=0, keepdim=True)[0]
        params_norm = 2 * (params_raw - params_min) / (params_max - params_min) - 1
