...
from model.dataset import ThermalHeatSourceDataset
from model.model import SimplePINN
...
def parse_args():
    ...
    parser.add_argument("--log_dir", type=str, default="logs/model")
    parser.add_argument("--ckpt_dir", type=str, default="checkpoints/model")
